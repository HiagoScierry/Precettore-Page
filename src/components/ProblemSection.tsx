...
const ProblemSection: React.FC = () => {
  // Mapeamento dos problemas citados no PDF para evitar repetição de código
  const problems = [
  ...
  return (
    <section className='bg-brand-dark/50 py-20 lg:py-32 border-t border-b border-white/5'>
